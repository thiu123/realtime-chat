...
import { User, Mail, Lock, Eye, EyeOff, MessageSquare, Sparkles, Lock as LockIcon, Users } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen noise-bg" style={{ background: "var(--nx-surface-0)" }}>
      ...
      >
        ...
        {/* Floating glow orbs */}
        <div
          className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full blur-[120px] opacity-20"
          style={{ background: "var(--nx-violet-500)" }}
        />
        <div
          className="absolute bottom-1/4 left-1/3 w-56 h-56 rounded-full blur-[100px] opacity-15"
        ...
        <div className="relative z-10">
          <h1 className="text-5xl font-bold text-white mb-6 leading-tight tracking-tight">
            Start chatting in
            <br />
            <span className="accent-text-gradient">seconds.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 mt-8">
            {[
              ...
              { icon: LockIcon, label: "End-to-end" },
              ...
              >
                <f.icon className="w-4 h-4" style={{ color: "var(--nx-violet-400)" }} />
                {f.label}
              </div>
            ))}
          </div>
        ...
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm" style={{ color: "var(--nx-text-secondary)" }}>
                Full Name
              </Label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: "var(--nx-text-ghost)" }} />
                <Input
                  id="name"
                  type="text"
                  ...
                  style={{ background: "var(--nx-surface-3)", borderColor: "var(--nx-glass-border)" }}
                />
              </div>
            </div>
            ...
            {/* Confirm Password */}
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-sm" style={{ color: "var(--nx-text-secondary)" }}>
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: "var(--nx-text-ghost)" }} />
            ...
            <div className="flex items-start space-x-2">
              ...
              />
              <label htmlFor="terms" className="text-sm leading-relaxed cursor-pointer" style={{ color: "var(--nx-text-tertiary)" }}>
                I agree to the{" "}
                <Link href="#" className="underline-offset-4 hover:underline" style={{ color: "var(--nx-accent-400)" }}>
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="#" className="underline-offset-4 hover:underline" style={{ color: "var(--nx-accent-400)" }}>
            ...
            <p className="text-center text-sm" style={{ color: "var(--nx-text-ghost)" }}>
              ...
              <Link href="/login" className="underline-offset-4 hover:underline font-medium" style={{ color: "var(--nx-accent-400)" }}>
                Log in
              </Link>
            </p>
          </form>
