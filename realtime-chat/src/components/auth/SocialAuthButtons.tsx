...
interface SocialAuthButtonsProps {
  /** Chữ trên đường kẻ ngang, ví dụ "or continue with". */
  dividerLabel: string;
}

/**
 * Hai nút đăng nhập bằng Google / GitHub.
 *
 * Backend hiện chưa có OAuth nên hai nút đang bị khoá. Muốn bật thì phải làm
 * route /auth/google và /auth/github ở backend trước, rồi bỏ `disabled` đi.
 */
